...
def main(args, train_tumor_coord_path, train_normal_coord_path, valid_tumor_coord_path, valid_normal_coord_path,
    ...
    if (not use_pretrained_model_weights_path) and (initial_epoch == 0):
        ...
        # model = Deeplabv3(input_shape=(256, 256, 3), weights='pascal_voc', classes=2,  backbone='mobilenetv2', OS=16, activation='softmax')
        model = Deeplabv3(input_shape=(256, 256, 3), weights='pascal_voc', classes=2,  backbone='xception', OS=16, activation='softmax')        
...
if __name__ == '__main__':
    ...
    main(args, train_tumor_coord_path, train_normal_coord_path, valid_tumor_coord_path, valid_normal_coord_path,\
     model_path, use_pretrained_model_weights_path=pretrained_model_path, restore_model=False, initial_epoch=0, n_Epochs=100)
