...
model_dict = {
        'test_1': load_incep_resnet('../../results/saved_models/incep_imagenet_200k/5fold_0/sel-model.11-0.16.h5'),
        'test_2': load_unet_densenet('../../results/saved_models/dense_viable_200k/5fold_3/model.28-0.08.h5'),
        'test_3': load_deeplabv3('../../results/saved_models/deeplab_viable_200k/5fold_4/sel-model.20-0.13.h5',OS=8),
        }
model_keys = list(model_dict.keys())
ensemble_key = 'test_final'
...
# for i,sample_id in enumerate(sample_ids):
    ...
    for i,(data, xes, ys, label) in enumerate(dataloader):
        ...
        for key in model_keys:
            pred_map_dict[key] = model_dict[key].predict(image_patches,verbose=0,batch_size=4)
